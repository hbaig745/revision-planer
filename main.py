...
login_frame = ttk.LabelFrame(login_tab, text='PICK A SUBJECT', relief="groove", padding=5)
register_frame = ttk.LabelFrame(login_tab, text='ADD SUBJECT', relief="groove", padding=5)
delete_subject_frame = ttk.LabelFrame(login_tab, text='DELETE SUBJECT', relief="groove", padding=5)
...
try:
    ...
    pass
login_combo = ttk.Combobox(login_frame, width=30, state='readonly', values=array, postcommand=get_subjects)
login_combo.grid(row=1)
register_entry = ttk.Entry(register_frame, width=30)
register_entry.grid(row=1)
delete_combo = ttk.Combobox(delete_subject_frame, width=30, state='readonly', values=array, postcommand=get_subjects)
...
ttk.Button(delete_subject_frame, width=50, command=delete_subject, text='DELETE').grid(row=2)

ttk.Button(login_tab, command=restart, text='RESTART').grid(row=1, sticky=EW, columnspan=3)
ttk.Button(login_tab, command=quit_button, text='QUIT').grid(row=2, sticky=EW, columnspan=3)
...
random_frame = ttk.LabelFrame(subject_tab, text='Random Topic', relief="groove", padding=5)
...
add_topic_frame = ttk.LabelFrame(subject_tab, text='Add Topic', relief="groove", padding=5)
...
delete_topic_frame = ttk.LabelFrame(subject_tab, text='Delete Topic', relief="groove", padding=5)
...
delete_topic = ttk.Combobox(delete_topic_frame, values=topic_array, postcommand=get_topics, state='readonly')
delete_topic.grid()
